...
const defaultCardData: BentoCardProps[] = [
  ...
  },
  {
    ...
    description:
      "Our team of photographers, videographers, and directors brings decades of combined expertise to every shoot.",
    label: "Our Team",
  ...
  },
  {
    ...
    title: "Our Mission",
    description:
      "To capture authentic stories that resonate with audiences and elevate brands to new heights through visual innovation.",
    label: "Vision",
  },
  {
    color: "#0a0a0a",
...
const BentoCardGrid: React.FC<{
  ...
  <div className="bento-section grid gap-3 p-3 w-full max-w-6xl mx-auto select-none relative" ref={gridRef}>
    {children}
  </div>
)
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive">
          {cards.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative aspect-[4/3] min-h-[200px] w-full max-w-full p-5 rounded-lg border border-white/10 font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 ${
            ...
            if (enableStars) {
              return (
                ...
                >
                  {card.image && <div className="absolute inset-0 bg-black/60" />}
                  <div className="card__header flex justify-between gap-3 relative text-white z-10">
                    <span className="card__label text-xs uppercase tracking-wider text-white/60">{card.label}</span>
                  </div>
